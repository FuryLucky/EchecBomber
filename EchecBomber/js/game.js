(function(){  //  ANTIHACK  BI*CH 
  ...
  var playerEx = document.querySelector('#explosion');
  var playerPut = document.querySelector('#put');
  ...
  var engine = {
    ...
    _init: function(){   // (load game)   /!\ ne pas toucher /!\
      this.genTab();
      this.listener();
      this.setCell();
      this.listener2();
    ...
    vie: function(x,y){  
      if ($('.active').hasClass('explosion')) { 
        ...
        if (vie1 === 2) {
          ...
          setTimeout(function(){ alert("PURPLE PLAYER DIED");  }, 500); 
    ...
    vie2: function(x,y){  
      if ($('.active2').hasClass('explosion')) { 
        ...
        if (vie2 === 2) {
          ...
          setTimeout(function(){ alert("ORANGE PLAYER DIED");  }, 500); 
          setTimeout(function(){ window.location.href = "index.html"; }, 1000);        
        }
      }
    },
...
PxGamepad.prototype.update = function() {
  ...
  //                   MUSIC                       //
  var playerMusic = document.querySelector('#music');
  playerMusic.play(0.3, true);
